      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 pb-24 relative z-10">
        <div className="space-y-8">
          ...
          <div className="flex gap-5">
            {[MessageSquare, Code, Globe, Send].map((Icon, i) => (
              <Link key={i} href="#" className="w-12 h-12 bg-slate-900 flex items-center justify-center rounded-2xl hover:bg-primary transition-all border border-slate-800 hover:scale-110 hover:shadow-2xl">
